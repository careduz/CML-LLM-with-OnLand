...
def main():
    ...
    demo = gr.ChatInterface(
        ...
        additional_inputs=[
            ...
            gr.Radio(
                ["None", "Pinecone"], label="Vector Database Choices", value="None"
            ),
        ],
        retry_btn=None,
        undo_btn=None,
...
def get_llama2_response_with_context(question, context, temperature, token_count):
    ...
    question = "Answer this question based on the given context. Question: " + str(
        question
    )
    ...
    try:
        ...
        question_and_context = (
            f"{llama_sys} {llama_inst} [INST] User: {question} [/INST]"
        )
